...
<div class="akeeba-panel--info">
    ...
    <form action="<?php echo $data->url ?>" method="post" id="paymentForm" class="akeeba-form--horizontal">
        <p>
            <input class="akeeba-btn--primary" type="submit"/>
        </p>
        ...
        <div class="akeeba-hidden-fields-container">
            ...
            <input type="hidden" name="c_description_1"
                   value="<?php echo $level->title . ' - [ ' . $user->username . ' ]' ?>"/>
            ...
            <input type="hidden" name="pay_method"
                   value="<?php echo strtoupper($data->params->get('pay_method', 'cc')) ?>"/>
