...
<div class="akeeba-panel--primary">
	 ...
	 */
	?>
    <div class="akeeba-form-horizontal" id="ccform">
        <div class="akeeba-form-group" id="control-group-card-holder">
            ...
            <input type="text" name="card-holder" id="card-holder"
                   value="<?php echo $data->cardholder ?>"/>
        </div>
        <div class="akeeba-form-group" id="control-group-card-number">
            <label for="card-number">
				<?php echo JText::_('PLG_AKPAYMENT_PAYMILL_FORM_CC') ?>
            </label>
            <input type="text" name="card-number" id="card-number"/>
        </div>
        <div class="akeeba-form-group" id="control-group-card-expiry">
        ...
        <div class="akeeba-form-group" id="control-group-card-cvc">
            <label for="card-cvc">
        ...
        <div class="akeeba-form-group--pull-right">
            <div class="akeeba-form-group--actions">
                <a href="#ccform" id="payment-button" class="akeeba-btn--green--block">
	...
	function PaymillResponseHandler (error, result)
	{
		(function ($)
		{
			...
			if (error)
			{
				...
				{
					$("#payment-errors").html(
						'<?php echo JText::_('PLG_AKPAYMENT_PAYMILL_FORM_3INTERNAL_SERVER_ERROR') ?>');
				}
				...
				{
					$("#payment-errors").html(
						'<?php echo JText::_('PLG_AKPAYMENT_PAYMILL_FORM_INVALID_PUBLIC_KEY') ?>');
				}
				...
				{
					$("#payment-errors").html(
						'<?php echo JText::_('PLG_AKPAYMENT_PAYMILL_FORM_INVALID_CARD_NUMBER') ?>');
				...
				{
					$("#payment-errors").html(
						'<?php echo JText::_('PLG_AKPAYMENT_PAYMILL_FORM_INVALID_CARD_HOLDER') ?>');
