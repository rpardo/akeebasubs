...
<div class="akeeba-form-group">
    ...
    @jhtml('FEFHelper.select.booleanswitch', 'recurring', $item->recurring)
</div>
...
<div class="akeeba-form-group">
    ...
    @jhtml('FEFHelper.select.booleanswitch', 'only_once', $item->only_once)
</div>
...
<div class="akeeba-form-group">
    ...
    <input type="text" name="renew_url" id="renew_url" value="{{{ $item->renew_url }}}">
...
<div class="akeeba-form-group">
    ...
    <input type="text" name="content_url" id="content_url" value="{{{ $item->content_url }}}">
    <p class="akeeba-help-text">
...
<div class="akeeba-form-group">
    ...
    <input type="number" name="notify1" id="notify1" value="{{{ $item->notify1 }}}">
</div>
...
<div class="akeeba-form-group">
    ...
    <input type="number" name="notify2" id="notify2" value="{{{ $item->notify2 }}}">
</div>
...
<div class="akeeba-form-group">
    ...
    <input type="number" name="notifyafter" id="notifyafter" value="{{{ $item->notifyafter }}}">
</div>
