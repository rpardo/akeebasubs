<?php
/**
 * Akeeba Subscriptions – New subscription: ATOOLSWP
 *
...
@section('message')
    ...
    <p>
        The [LEVEL] subscription gives you access to downloads and support for Admin Tools Professional for WordPress!.
    </p>
    <p>
    ...
    @include('any:com_akeebasubs/Templates/blurb_atoolswp')
@stop