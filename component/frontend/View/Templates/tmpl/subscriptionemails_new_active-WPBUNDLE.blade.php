<?php
/**
 * Akeeba Subscriptions – New subscription: WPBUNDLE
 *
...
@section('message')
    ...
    <ul>
        <li>Akeeba Backup Professional for WordPress</li>
        <li>Admin Tools Professional for WordPress</li>
    ...
    @include('any:com_akeebasubs/Templates/blurb_backupwp')
