<?php
/**
 * Akeeba Subscriptions – New subscription: AKEEBATICKETS
 *
...
@section('message')
    ...
    <p>
        The [LEVEL] subscription gives you access to downloads and support for Akeeba Ticket System Professional for Joomla!.
    </p>
    <p>
        You can find the links to the downloads, documentation and support below.
    </p>
    <p>
    ...
    @include('any:com_akeebasubs/Templates/blurb_akeebatickets')
@stop