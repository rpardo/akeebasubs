<?php
/**
 * Akeeba Subscriptions – New subscription: ADMINTOOLS
 *
...
@section('message')
    ...
    <p>
        The [LEVEL] subscription gives you access to downloads and support for Admin Tools Professional for Joomla!.
    </p>
    <p>
        You can find the links to the downloads, video tutorials, documentation and support below.
    </p>
    <p>
    ...
    @include('any:com_akeebasubs/Templates/blurb_admintools')
@stop