...
<div class="akemail-product-buttons">
    @unless(empty($download_url))
        @include('any:com_akeebasubs/Templates/blurb_button', [
            'title' => 'Download',
            'img_url' => 'https://www.akeebabackup.com/images/email-template/download.png',
    ...
    @unless(empty($video_url))
        @include('any:com_akeebasubs/Templates/blurb_button', [
            ...
            'img_url' => 'https://www.akeebabackup.com/images/email-template/video.png',
    ...
    @unless(empty($docs_url))
        @include('any:com_akeebasubs/Templates/blurb_button', [
            'title' => 'Documentation',
            'img_url' => 'https://www.akeebabackup.com/images/email-template/book.png',
            'target_url' => $docs_url
        ])
    @endunless
    @unless(empty($support_url))
        @include('any:com_akeebasubs/Templates/blurb_button', [
            'title' => 'Support',
            'img_url' => 'https://www.akeebabackup.com/images/email-template/support.png',
